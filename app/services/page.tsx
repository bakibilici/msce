...
export default function Services() {
  ...
  return (
    <div ref={containerRef} className="flex flex-col items-center justify-start w-full bg-[#EEECE2] font-sans">
        ...
        <motion.div style={{ y: yHeading, opacity: opacityHeading }} className="z-10">
          ...
          <FadeIn delay={0.2}>
            <p className="mt-12 max-w-2xl text-xl leading-relaxed text-[#757776] font-light">
              Uluslararası standartlarda inşaat süreci, tasarım ve bütçe yönetimi hizmetleri ile projelerinize değer katıyoruz.
            </p>
          </FadeIn>
        </motion.div>
      </section>
      ...
      <section className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 py-24 border-x border-[#262827]/10 space-y-32 overflow-hidden bg-[#EEECE2]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          <FadeIn className="order-2 lg:order-1 relative aspect-square w-full bg-[#e0dcd0] border border-[#262827]/10 flex flex-col items-center justify-center p-8 overflow-hidden">
             <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'linear-gradient(45deg, #757776 25%, transparent 25%, transparent 75%, #757776 75%, #757776), linear-gradient(45deg, #757776 25%, transparent 25%, transparent 75%, #757776 75%, #757776)', backgroundSize: '10px 10px', backgroundPosition: '0 0, 5px 5px' }}></div>
            <h4 className="text-[10px] md:text-xs text-[#757776] font-bold tracking-widest uppercase mb-4 z-10">Süreç</h4>
            <StaggerContainer className="flex flex-col items-center gap-4 text-[#262827] font-mono text-xs md:text-sm z-10">
              <StaggerItem>Ön Tasarım</StaggerItem>
              <StaggerItem className="h-4 w-[1px] bg-[#262827]"></StaggerItem>
              <StaggerItem>Konsept Tasarım</StaggerItem>
              <StaggerItem className="h-4 w-[1px] bg-[#262827]"></StaggerItem>
              <StaggerItem>Projelendirme</StaggerItem>
              <StaggerItem className="h-4 w-[1px] bg-[#262827]"></StaggerItem>
              <StaggerItem>Uygulama</StaggerItem>
            </StaggerContainer>
          </FadeIn>
          <FadeIn delay={0.2} className="order-1 lg:order-2">
            ...
            <p className="text-[#757776] leading-relaxed font-light mb-6">
              Müşterinin talepleri doğrultusunda teknik ve mali olanaklar değerlendirilerek alternatif çözümlerle ön tasarım hazırlanır.
              Onaylanan konsept tasarım sonrası yüksek hassasiyetli ölçüm cihazları ile detaylı uygulama çizimleri oluşturulur.
              Standart iş güvenliği önlemleri altında uygulama süreci eksiksiz ve planlı yönetilir.
            </p>
          </FadeIn>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start pt-32 border-t border-[#262827]/10">
          ...
          <FadeIn delay={0.2} className="relative aspect-square w-full bg-[#d5cfc0] border border-[#262827]/10 flex flex-col items-center justify-center p-8 overflow-hidden">
             <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'linear-gradient(90deg, #757776 1px, transparent 1px), linear-gradient(180deg, #757776 1px, transparent 1px)', backgroundSize: '40px 40px' }}></div>
            <span className="text-[10px] md:text-xs text-[#757776] font-bold tracking-widest uppercase z-10">[ İllüstrasyon Gelecek ]</span>
          </FadeIn>
        </div>

        {/* BIM Süreci */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start pt-32 border-t border-[#262827]/10">
          <FadeIn className="order-2 lg:order-1 relative aspect-square w-full bg-[#e0dcd0] border border-[#262827]/10 flex flex-col items-center justify-center p-8 group overflow-hidden">
             <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'linear-gradient(45deg, #757776 25%, transparent 25%, transparent 75%, #757776 75%, #757776)', backgroundSize: '20px 20px', backgroundPosition: '0 0, 10px 10px' }}></div>
            <span className="text-[10px] md:text-xs text-[#757776] font-bold tracking-widest uppercase z-10">[ LOD 100-500 Model ]</span>
          </FadeIn>
          <FadeIn delay={0.2} className="order-1 lg:order-2">
